              ...
              <span
                className={cn(
                  ...
                  active
                    ...
                    : "border-white/[0.08] bg-white/[0.03] text-zinc-400 group-hover:text-cyan-300",
                )}
              >
                <Icon className="h-4 w-4" strokeWidth={1.8} />
              </span>
              <span className="min-w-0 flex-1">
                <span className={cn("block text-sm font-semibold", active ? "text-cyan-200" : "text-zinc-200")}>
                  {rec.name}
                </span>
